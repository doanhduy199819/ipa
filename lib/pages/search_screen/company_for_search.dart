...
class _CompanyForSearchState extends State<CompanyForSearch> {
  ...
  void searchFunction()
  {
    _company=_company.where((element) => element.name!.toLowerCase().contains(this.widget.searchTitle.toLowerCase())).toList();
  }
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  ...
                  builder: (context) =>  CompanyQA(idCompany: _company[index].id!,nameCompany:_company[index].name!,),
                ),
              );
            },
            child: Container(
